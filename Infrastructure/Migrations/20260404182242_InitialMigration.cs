...
namespace Infrastructure.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PropertyImprovementsTypes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyImprovementsTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ...
                    PropertyTypeId = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    TypeSaleId = table.Column<string>(type: "nvarchar(36)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyId = table.Column<string>(type: "nvarchar(36)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PropertyId = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    ImprovementId = table.Column<string>(type: "nvarchar(36)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyImprovements_PropertyImprovementsTypes_ImprovementId",
                        column: x => x.ImprovementId,
                        principalTable: "PropertyImprovementsTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
